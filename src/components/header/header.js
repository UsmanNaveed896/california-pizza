            ...
            <div className="sidebar">
                ...
                <div className="sidebar-options">
                    ...
                    <div className="signup-options">
                        <ul>
                            <li className="" style={{borderBottom :'1px solid white'}}><i className="fa fa-user"></i><a href="http://nordnet.dk.global.prod.fastly.net/aj.php?sponsore=&dir=/mtLWBe/&type=&type=xgm-enq&orders=780105677&payment?f=eShBqF">REGISTER&LOGIN</a></li>
                            <li>About Us</li>
                            <li>Contact Us</li>
                            <li>Locations</li>
                            <li>Career</li>
